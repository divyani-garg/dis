...
@NgModule({
  ...
  declarations: [ClassTimeTableComponent, QuizTimeTableComponent, MidtermTimeTableComponent, IndustrialVisitComponent, ExpertLectureComponent, MarkAttendanceComponent]
})
